...
"%CCES_HOME%\cldp.exe" -verbose -proc ADSP-SC589 -core 1 -emu 2000 -driver Supporting_Files/sam_dpia_Core1.dxe -cmd prog -erase affected -format bin -file Output_LDR_Files/%1-SC589.ldr 
@echo Done!
goto :eof
)
...
@echo Example: prog_SAM_flash_ice2000.bat SHARC_App
