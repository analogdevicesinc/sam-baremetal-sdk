...
//****************************************************************************
// Note: for newer SHARC Audio Module boards, the HADC_MIN value will change 
// once these inputs are buffered
 ...
 */
void _system_timer_handler(void *pCBParam, uint32_t Event, void *pArg) {
