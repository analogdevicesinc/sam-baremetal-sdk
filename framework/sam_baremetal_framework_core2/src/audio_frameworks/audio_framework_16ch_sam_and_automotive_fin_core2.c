...
#include "audio_framework_16ch_sam_and_automotive_fin_core2.h"
...
// 16 channels of audio from SHARC Core 1
...
float *audiochannel_4_left_in  = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 8;
float *audiochannel_4_right_in = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 9;
float *audiochannel_5_left_in  = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 10;
float *audiochannel_5_right_in = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 11;
float *audiochannel_6_left_in  = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 12;
float *audiochannel_6_right_in = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 13;
float *audiochannel_7_left_in  = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 14;
float *audiochannel_7_right_in = AudioChannels_From_SHARC_Core1 + AUDIO_BLOCK_SIZE * 15;

// 16 channels of processed audio to be sent back to DACs via SHARC Core 1
...
float *audiochannel_4_left_out  = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 8;
float *audiochannel_4_right_out = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 9;
float *audiochannel_5_left_out  = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 10;
float *audiochannel_5_right_out = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 11;
float *audiochannel_6_left_out  = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 12;
float *audiochannel_6_right_out = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 13;
float *audiochannel_7_left_out  = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 14;
float *audiochannel_7_right_out = AudioChannels_To_SHARC_Core1 + AUDIO_BLOCK_SIZE * 15;
 ...
 * that we are ready for audio.  Once core 1 finishes initialzing the DMA, etc. it will
...
#endif    // __AUDIO_FRAMEWORK_SINGLEDUAL_CORE_16CH_AUTOMOTIVE__
